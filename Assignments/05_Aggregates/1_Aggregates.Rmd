...
The CSV file we're going to read from is a [Basketball Reference](https://www.basketball-reference.com/leagues/NBA_2022_advanced.html) page of advanced metrics for NBA players this past season. The Sports Reference sites are a godsend of data, a trove of stuff, and we're going to use it a lot in this class. Here's [the file](https://dwillis.github.io/sportsdatafiles/nbaadvancedplayers2122.csv), you should download it and save it in your class data folder.
...
We're going to put it all together now. We're going to calculate some mean and medians from 2022 NCAA women's basketball stats. 

Answer these questions:

1. What are the mean and median number of assists for all guards? And how many guards are there?
2. What are the median number of assists for Big Ten guards? And how does that compare to the average number of assists for that conference?
3. What conference has the highest mean number of assists? How does that compare with the median?

To do this, you'll need to [download the 2022 WBB cumulative data for guards who played at least 500 minutes](https://raw.githubusercontent.com/dwillis/jour479x-exercises/master/Data/wbb_guards_2022.csv).
